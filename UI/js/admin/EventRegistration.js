 ...
 * @class eb_EventRegistrationAdmin
 * */
var eb_EventRegistrationAdmin = eb_EventRegistrationAdmin || {};

/**
 * Control level setting: Site path.
 * @property eb_EventRegistrationAdmin.SitePath
 * @type {String}
 */
eb_EventRegistrationAdmin.SitePath = eb_Config.SitePath;

/**
 * Control level setting Template path.
 * @property eb_EventRegistrationAdmin.TemplatePath
 * @type {String}
 */
eb_EventRegistrationAdmin.TemplatePath = "html/admin/EventRegistration.html";

/**
 * The path to the eBusiness SOA layer.
 * @property eb_EventRegistrationAdmin.ServicePath
 * @type {String}
 */
eb_EventRegistrationAdmin.ServicePath = eb_Config.ServicePathV1;

/**
 * GET service to get the speaker info
 * @property eb_EventRegistrationAdmin.getSpeakerData
 * @type {String}
 */
eb_EventRegistrationAdmin.getSpeakerData = eb_EventRegistrationAdmin.ServicePath + "admin/company/{id}/Events/{eventId}/Speakers" + "?includeSessionSpeakers=true";

/**
 * GET service to get the session Info
 * @property eb_EventRegistrationAdmin.getSessionInfoData
 * @type {String}
 */
eb_EventRegistrationAdmin.getSessionInfoData = eb_EventRegistrationAdmin.ServicePath + "admin/company/{id}/Events/{eventId}/Sessions";

/**
 * GET event search result
 * @property eb_EventRegistrationAdmin.getSearchDetails
 * @type {String}
 */
eb_EventRegistrationAdmin.getSearchDetails = eb_EventRegistrationAdmin.ServicePath + "admin/company/{id}/Events/Attendees/Search?SearchTerm={SearchTerm}";

/**
 * POST to Create New Attendee
 * @property eb_EventRegistrationAdmin.createNewAttendee
 * @type {String}
 */
eb_EventRegistrationAdmin.createNewAttendee = eb_EventRegistrationAdmin.ServicePath + "admin/company/{id}/Events/Attendees";

/**
 * Default product image.
 * @property eb_EventRegistrationAdmin.defaultImage
 * @type {String}
 */
eb_EventRegistrationAdmin.defaultImage = "../images/products/coming-soon.png";

/**
 * Get product event id from URL
 * @property eb_EventRegistrationAdmin.productId
 * @type {String}
 */
eb_EventRegistrationAdmin.productId = eb_Config.getUrlParameter("productId");

/**
 * Get session true/false from URL
 * @property eb_EventRegistrationAdmin.hasSessions
 * @type {String}
 */
eb_EventRegistrationAdmin.hasSessions = eb_Config.getUrlParameter("hasSessions");

/**
 * Character length for show more and show less functionality
 * @property eb_EventRegistrationAdmin.charLength
 * @type {Number}
 * */
eb_EventRegistrationAdmin.charLength = 450;

/**
 * set second for search service call - [After particular second the search service call will be hit]
 * @property eb_EventRegistrationAdmin.setSecond
 * @type {Number}
 * */
eb_EventRegistrationAdmin.setSecond = 2000; /*It is in milliseconds [1000 milliseconds == 1 seconds]*/

/**
 * Process Button URL
 * @property eb_EventRegistrationAdmin.proceedButtonURL
 * @type {String}
 * */
eb_EventRegistrationAdmin.proceedButtonURL = eb_EventRegistrationAdmin.SitePath + "admin/ViewCart.html";

/* Error messages */
eb_EventRegistrationAdmin.errorMessages = {
 ...
 * 
 * @property eb_EventRegistrationAdmin.errorResponses
 * @type {Object}
 * */
eb_EventRegistrationAdmin.errorResponses = {
    ...
    405: { useServerMessage: true }
};

/**
 * Default error message.
 * @property eb_EventRegistrationAdmin.defaultErrorMessage
 * @type {String}
 * */
eb_EventRegistrationAdmin.defaultErrorMessage = 'Sorry, there was an unexpected error. If the problem persists, please contact customer support for further assistance.';
 ...
 * @method eb_EventRegistrationAdmin.render
 * @param {any} options
 ...
 * */
eb_EventRegistrationAdmin.render = function (options) {
    ...
    if (options) {
        ...
        if (!options.templatePath) {
            var finalPath = eb_eventRegistration.SitePath + eb_EventRegistrationAdmin.TemplatePath;
 ...
 * @method eb_EventRegistrationAdmin.getSpeakerInfo
 ...
 * */
eb_EventRegistrationAdmin.getSpeakerInfo = function (companyId, eventId, hasSession) {
    ...
    if (hasSession) {
        ...
        eBusinessJQObject.get(
            {
                url: eb_EventRegistrationAdmin.getSpeakerData.replace("{id}", companyId).replace("{eventId}", eventId),
                xhrFields: {
...
/** 
 * Get Session Details
 * @method eb_EventRegistrationAdmin.getSessionDetails
 * @param {Boolean} hasSession True/False value for validating the session is available or not
 * @param {Number} eventId EventId 
 * @return {Object} To get session details
 * */
eb_EventRegistrationAdmin.getSessionDetails = function (companyId, eventId, hasSession) {
    var deferred = eBusinessJQObject.Deferred();
    ...
    if (hasSession) {
        ...
        eBusinessJQObject.get(
            {
                url: eb_EventRegistrationAdmin.getSessionInfoData.replace("{id}", companyId).replace("{eventId}", eventId),
                xhrFields: {
                    withCredentials: true
                }
            }
...
/** 
 * Get Search Results
 * @method eb_EventRegistrationAdmin.getSearchData
 * @param {String} Search Text data to search the record
 * @return {Object} To get all search record
 * */
eb_EventRegistrationAdmin.getSearchData = function (search) {
    var deferred = eBusinessJQObject.Deferred();
    ...
    eBusinessJQObject.get(
        {
            url: eb_EventRegistrationAdmin.getSearchDetails.replace("{id}", eb_EventRegistrationAdmin.companyId).replace("{SearchTerm}", search),
            xhrFields: {
                withCredentials: true
            }
        }
...
/** 
 * POST to Create New Attendee
 * @method eb_EventRegistrationAdmin.createAttendee
 ...
 * */
eb_EventRegistrationAdmin.createAttendee = function (firstName, lastName, email, city) {
    var deferred = eBusinessJQObject.Deferred();
    ...
    var serviceURL = eb_EventRegistrationAdmin.createNewAttendee.replace("{id}", eb_EventRegistrationAdmin.companyId);
 ...
 * @method eb_EventRegistrationAdmin.model
 * @param {any} options
 ...
 */
eb_EventRegistrationAdmin.model = function (options) {
    var _that = this;
    if (!options) {
    ...
    _that.search = ko.observable().extend({ rateLimit: eb_EventRegistrationAdmin.setSecond }); /* Set the second */
    ...
    eb_EventRegistrationAdmin.domElement(_that.domElement);
    ...
    if (options.companyId) {
        eb_EventRegistrationAdmin.companyId = options.companyId;
    }
    ...
    if (options.shoppingCart) {
        ...
        eb_EventRegistrationAdmin.shoppingCart(options.shoppingCart);
    }

    /*To retrieve registration summary of meeting*/
    ...
    /*To retrieve all the meeting and session data*/
    _that.getAttendeeData = function () {
        _that.errorCreateAttendee(0);
        _that.showLoader(1);
        eb_adminShoppingCart.eventProductItems().done(function (result) {
            _that.showLoader(0);
            if (result.length > 0) {
                eBusinessJQObject.map(result, function (row) {
                    if (row.productType.toLowerCase() === "meeting") {
                        if (eb_EventRegistrationAdmin.productId == row.productId || eb_EventRegistrationAdmin.productId == row.parentproductId) {
    ...
    _that.proceedClick = function () {
        if (eb_EventRegistrationAdmin.proceedButtonURL) {
            window.location.assign(eb_EventRegistrationAdmin.proceedButtonURL);
        }
        else {
    ...
    _that.search.subscribe(function () {
        ...
        if (result.length > 0) {
            if (result.length > 2) {
                eBusinessJQObject.when(eb_EventRegistrationAdmin.getSearchData(result)).done(function (searchResult) {
    ...
    _that.sessionListDetails = function (data) {
        ...
        self.sessionClicked = function () {
            /*If a new person is being created, then do not check if session is already registered or not*/
            if (_that.newFirstName() == "" && _that.newLastName() == "" && _that.newCity() == "" && _that.newEmail() == "") {
                /*logic to check if all sessions are selected/unselected and change text of Select/Unselect All accordingly */
                var isSelected = true;
                var isUnselected = true;
                var isSessionAdded = true;
                var personId = _that.personId();
                ...
                /*To check if Attendee is registered to the meeting and also check whether the session is selected*/
                    ...
                    var registerSession = ko.utils.arrayFirst(registerMeeting.registerSession(), function (row) {
                        if (row.sessionProductId() == self.sessionId() && row.sessionAttendeeId() == personId) {
                            ...
                            if (_that.personFirstName() && _that.personLastName()) {
                                self.sessionErrorMessage(eb_EventRegistrationAdmin.errorMessages['Session already registered'].replace("name", row.sessionName()) + _that.personFirstName() + " " + _that.personLastName());
                                isSessionAdded = false;
                                self.selectTheSession(false)
                            }
                            else {
                                self.sessionErrorMessage(eb_EventRegistrationAdmin.errorMessages['Session already registered'].replace("name", row.sessionName()) + _that.newFirstName() + " " + _that.newLastName());
                                isSessionAdded = false;
                                self.selectTheSession(false)
                            }
                            //else {
                            //    self.sessionErrorMessage(eb_EventRegistrationAdmin.errorMessages['Session already registered'].replace("name", row.sessionName()) + eb_EventRegistrationAdmin.userName);
                            //    isSessionAdded = false;
                            //    self.selectTheSession(false)
                            //}
                            if (isSessionAdded) {
        ...
        self.showMoreData = function (data) {
            ...
            var showDescription = description.substr(0, eb_EventRegistrationAdmin.charLength);
        ...
        self.checkEventDescription = function (data) {
            ...
            if (descriptionLength.length < eb_EventRegistrationAdmin.charLength) {
    ...
    _that.addSelectedSessionToAttendee = function (sessionId, quantity, productType, personId) {
        ...
        if (registerMeeting) {
            eb_EventRegistrationAdmin.shoppingCart.addToCart(addSession).done(function (result) {
                _that.showLoader(0);
            ...
            _that.errorCreateAttendeeMessage(eb_EventRegistrationAdmin.errorMessages['No attendee selected']);
        }
        return def.promise();
    };
    ...
    _that.checkAttendeeAvailable = function (quantity, productType, attendeeId, productId) {
        ...
        if (!checkAttendeeExist(attendeeId)) {
            eb_EventRegistrationAdmin.shoppingCart.addToCart(addAttendee).done(function (result) {
                ...
                _that.addAttendeeSession(def, quantity, productType, attendeeId).done(function () {
                    _that.showLoader(1);
                    eb_EventRegistrationAdmin.shoppingCart.getShoppingCart().done(function (shoppingCart) {
                        _that.showLoader(0);
                        def.resolve(result);
                    }).fail(function (data, msg, jhr) {
                        _that.showLoader(0);
                        ...
                        if (data && typeof data.responseJSON !== 'undefined')
                            _that.errorCreateAttendeeMessage(eb_Config.getErrorMessageForControl(data.responseJSON, eb_EventRegistrationAdmin));
                        else
                            _that.errorCreateAttendeeMessage(eb_EventRegistrationAdmin.defaultErrorMessage);
                    });
                }).fail(function (data, msg, jhr) {
                    _that.showLoader(0);
                    _that.errorCreateAttendee(1);
            ...
            _that.showLoader(0);
            _that.errorCreateAttendee(1);
            _that.errorCreateAttendeeMessage(eb_EventRegistrationAdmin.errorMessages['Already registered for meeting']);
            _that.addAttendeeSession(def, quantity, productType, attendeeId).done(function () {
                _that.showLoader(1);
                eb_EventRegistrationAdmin.shoppingCart.getShoppingCart().done(function (shoppingCart) {
                    _that.showLoader(0);
    ...
    _that.addAttendee = function () {
        ...
        addAttendee.productId = eb_EventRegistrationAdmin.productId;
    ...
    _that.createAttendee = function () {
        ...
        createAttendee.productId = eb_EventRegistrationAdmin.productId;
        if (_that.newFirstName() && _that.newLastName() && _that.newCity() && _that.newEmail()) {
            _that.showLoader(1);
            eb_EventRegistrationAdmin.createAttendee(_that.newFirstName(), _that.newLastName(), _that.newEmail(), _that.newCity()).done(function (result) {
                ...
                if (xhr && typeof xhr.responseJSON !== 'undefined')
                    _that.errorCreateAttendeeMessage(eb_Config.getErrorMessageForControl(xhr.responseJSON, eb_EventRegistrationAdmin));
                else
                    _that.errorCreateAttendeeMessage(eb_EventRegistrationAdmin.defaultErrorMessage);
            });
        } else {
            _that.showLoader(0);
            _that.errorCreateAttendee(1);
            _that.errorCreateAttendeeMessage(eb_EventRegistrationAdmin.errorMessages['Enter new attendee details']);
        }
    };
    ...
    _that.removeMeeting = function (data) {
        if (data.id()) {
            ...
            _that.showLoader(1);
            eb_EventRegistrationAdmin.shoppingCart.removeEventItems(dataToRemove).done(function (result) {
    ...
    _that.selectUnselectAll = function () {
        ...
        if (_that.selectAllText() == "Select All") {
            ...
            if (_that.sessionErrorCount() > 0) {
                _that.selectError(1);
                if (_that.personFirstName() && _that.personLastName()) {
                    _that.selectAllErrorMessage(eb_EventRegistrationAdmin.errorMessages['Sessions already registered'].replace("name", _that.selectedSession()) + _that.personFirstName() + " " + _that.personLastName());
                }
                else {
                    _that.selectAllErrorMessage(eb_EventRegistrationAdmin.errorMessages['Sessions already registered'].replace("name", _that.selectedSession()) + _that.newFirstName() + " " + _that.newLastName());
                }
                //else {
                //    _that.selectAllErrorMessage(eb_EventRegistrationAdmin.errorMessages['Sessions already registered'].replace("name", _that.selectedSession()) + eb_EventRegistrationAdmin.userName);
                //}
    ...
    _that.unSelectExistingAttendee = function () {
        var personId = _that.personId();
        var registerMeeting = ko.utils.arrayFirst(_that.registerMeeting(), function (meetings) {
            return meetings.attendeeId() == personId;
        });
    ...
    /*Commenting out this piece of code as it won't be hit from Event Summary Control as all buttons("Register" and "Back to Events") are hidden for Event Registration page.*/
...
eb_EventRegistrationAdmin.shoppingCart = function (shoppingCart) {
    var self = this;
...
/**
 * Page DOM element.
 * @method eb_EventRegistrationAdmin.domElement
 * @param {object} domElement current DOM element.
 * */
eb_EventRegistrationAdmin.domElement = function (domElement) {
    var self = this;
...
eBusinessJQObject(eb_EventRegistrationAdmin.domElement).ajaxError(function (event, xhr, settings) {
    if (xhr && typeof xhr.responseJSON !== 'undefined' && (xhr.responseJSON.type === eb_Config.serviceErrorType['Security Requirement Failed'] || xhr.responseJSON.type === eb_Config.serviceErrorType['Http Response']))
        eb_Config.getErrorMessageForControl(xhr.responseJSON, eb_EventRegistrationAdmin);
});